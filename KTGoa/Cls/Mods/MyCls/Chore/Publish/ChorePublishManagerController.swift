//
//  ChorePublishManagerController.swift
//  Golaa
//
...
class ChorePublishManagerController: BasClasVC {
    ...
    private func configViews() {
        navTitle("publishManagement".meLocalizable())
        navBagColor(.xf2)
    ...
    private var list: [ChorePublishScene] = ChorePublishScene.allCases
...
extension ChorePublishManagerController: JXSegmentedListContainerViewDataSource {
