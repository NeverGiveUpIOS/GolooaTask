...
open class GTRefreshHeader: GTRefreshComponent {
    
    //MARK: - 创建header方法
    public class func headerWithRefreshingBlock(_ refreshingBlock: @escaping Block) -> GTRefreshHeader {
